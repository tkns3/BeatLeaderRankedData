...
for (int page = 1; ; page++)
{
    ...
    foreach (var l in res.data)
    {
        ...
        mapInfos.Add(new MapInfo()
        {
            ...
            UploadedTime = new DateTime(l.song.uploadTime, DateTimeKind.Utc).ToString("yyyy-MM-ddTHH:mm:ssZ"),
            Bpm = l.song.bpm,
            ...
            Ranked = true,
            RankedTime = new DateTime(l.difficulty.rankedTime, DateTimeKind.Utc).ToString("yyyy-MM-ddTHH:mm:ssZ"),
